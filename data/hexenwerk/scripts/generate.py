# for i in range(0,29):
#     file = open(f"C:/Users/Flynn/AppData/Roaming/.minecraft/saves/Hexenwerk Dev/datapacks/Hexenwerk Datapack/data/hexenwerk/functions/block/wand_crafter/return_item_to_player/{i}.mcfunction","w")
