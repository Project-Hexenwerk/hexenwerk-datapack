...
execute if entity @s[tag=!hexenwerk.dev_stone.just_switched] if predicate hexenwerk:holding/dev_stone_debug run function hexenwerk:dev/dev_stone/switch/disabled
