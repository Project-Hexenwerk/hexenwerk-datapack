execute store result score @s hexenwerk.selected_minecraft_slot run data get entity @s SelectedItemSlot
...
execute unless score @s hexenwerk.holding_wand_timer matches 1.. if score @s hexenwerk.selected_minecraft_slot = @s hexenwerk.selected_minecraft_slot_old run function hexenwerk:wand/on_select
execute if score @s hexenwerk.holding_wand_timer matches 1.. unless score @s hexenwerk.selected_minecraft_slot = @s hexenwerk.selected_minecraft_slot_old run function hexenwerk:wand/on_select
execute unless score @s hexenwerk.holding_wand_timer matches 1.. unless score @s hexenwerk.selected_minecraft_slot = @s hexenwerk.selected_minecraft_slot_old run function hexenwerk:wand/on_select
