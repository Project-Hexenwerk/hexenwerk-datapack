...
execute if predicate hexenwerk:is_sneaking unless predicate hexenwerk:is_holding_wand_offhand if score @s hexenwerk.used_wfoas matches 1.. run function hexenwerk:wand/swapslot_offhand
