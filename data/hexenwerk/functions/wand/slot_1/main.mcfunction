...
execute unless predicate hexenwerk:is_holding_wand_offhand store result score @s hexenwerk.mana_cost run data get entity @s SelectedItem.tag.hexenwerk-mana_cost[0]
execute if predicate hexenwerk:is_holding_wand_offhand store result score @s hexenwerk.mana_cost run data get entity @s Inventory[{Slot:-106b}].tag.hexenwerk-mana_cost[0]
