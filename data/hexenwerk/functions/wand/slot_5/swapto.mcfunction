...
scoreboard players set @s hexenwerk.spell_slot 5
...
item modify entity @s weapon.mainhand hexenwerk:swap_wand_slot/fifth
execute if predicate hexenwerk:holding/wand_offhand run item modify entity @s weapon.offhand hexenwerk:swap_wand_slot/fifth
