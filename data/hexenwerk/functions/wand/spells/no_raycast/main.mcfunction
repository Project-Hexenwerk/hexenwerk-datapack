...
playsound minecraft:block.amethyst_cluster.fall voice @s[tag=!mute_spell_sounds] ~ ~ ~ 0.5 0.2
playsound minecraft:item.axe.scrape voice @s[tag=!mute_spell_sounds] ~ ~ ~ 0.5 1.8
playsound minecraft:block.grindstone.use voice @s[tag=!mute_spell_sounds] ~ ~ ~ 0.5 2
...
execute unless score @s hexenwerk.spell_id matches 1010 unless predicate hexenwerk:holding/wand_offhand if score @s hexenwerk.spell_slot matches 4 run tellraw @a[tag=!hexenwerk.mute_spell_uses] ["","<",{"selector":"@s"},"> ",{"nbt":"SelectedItem.tag.hexenwerk-spell_chat_display[3]","entity":"@s","interpret":true},"!"]
execute unless score @s hexenwerk.spell_id matches 1010 unless predicate hexenwerk:holding/wand_offhand if score @s hexenwerk.spell_slot matches 5 run tellraw @a[tag=!hexenwerk.mute_spell_uses] ["","<",{"selector":"@s"},"> ",{"nbt":"SelectedItem.tag.hexenwerk-spell_chat_display[4]","entity":"@s","interpret":true},"!"]
...
execute unless score @s hexenwerk.spell_id matches 1010 if predicate hexenwerk:holding/wand_offhand if score @s hexenwerk.spell_slot matches 4 run tellraw @a[tag=!hexenwerk.mute_spell_uses] ["","<",{"selector":"@s"},"> ",{"nbt":"Inventory[{Slot: -106b}].tag.hexenwerk-spell_chat_display[3]","entity":"@s","interpret":true},"!"]
execute unless score @s hexenwerk.spell_id matches 1010 if predicate hexenwerk:holding/wand_offhand if score @s hexenwerk.spell_slot matches 5 run tellraw @a[tag=!hexenwerk.mute_spell_uses] ["","<",{"selector":"@s"},"> ",{"nbt":"Inventory[{Slot: -106b}].tag.hexenwerk-spell_chat_display[4]","entity":"@s","interpret":true},"!"]