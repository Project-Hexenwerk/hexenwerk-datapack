tellraw @a[tag=hexenwerk.debug] ["",{"text":"[DEBUG] ","color":"dark_red"},{"text":"-> ","color":"red"},{"text":"executing impact event for spell ","color":"red"},{"text":"ignis_temptates ","color":"aqua"},{"text":"(id: ","color":"red"},{"text":"1006","color":"gold"},{"text":")","color":"red"}]
