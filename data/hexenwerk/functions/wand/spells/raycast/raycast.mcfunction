...
execute if block ~ ~ ~ #hexenwerk:transparent unless entity @e[dx=0.1,dy=0.1,dz=0.1,tag=!hexenwerk.spell.caster] positioned ^ ^ ^0.1 run function hexenwerk:wand/spells/raycast/raycast
