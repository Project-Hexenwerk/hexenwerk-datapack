...
execute if score #current hexenwerk.spell_id matches 1006 if predicate hexenwerk:percent/5 run particle flame ^ ^ ^-0.1 0 0 0 0 1 force @a[tag=!hexenwerk.hide_spell_particles]
...
execute if score #current hexenwerk.spell_id matches 1008 if predicate hexenwerk:percent/5 run particle minecraft:block dirt ^ ^ ^ 0.2 0.2 0.2 1 2 force @a[tag=!hexenwerk.hide_spell_particles]
