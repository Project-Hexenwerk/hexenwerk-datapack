...
execute if score @s hexenwerk.spell_event_id matches 1004 run function hexenwerk:spell_events/start/consedo
execute if score @s hexenwerk.spell_event_id matches 1009 run function hexenwerk:spell_events/start/glacius
execute if score @s hexenwerk.spell_event_id matches 1010 run function hexenwerk:spell_events/start/commovus_motus
