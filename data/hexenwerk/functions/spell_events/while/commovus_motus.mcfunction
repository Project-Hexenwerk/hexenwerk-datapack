...
execute if entity @s[type=marker,tag=hexenwerk.commovus_motus_start] as @e[type=marker,tag=hexenwerk.commovus_motus_end] if score @s hexenwerk.id_2 = @e[type=marker,tag=hexenwerk.this,limit=1] hexenwerk.id_2 run tag @s add hexenwerk.linked
execute if entity @s[type=marker,tag=hexenwerk.commovus_motus_end] as @e[type=marker,tag=hexenwerk.commovus_motus_start] if score @s hexenwerk.id_2 = @e[type=marker,tag=hexenwerk.this,limit=1] hexenwerk.id_2 run tag @s add hexenwerk.linked
