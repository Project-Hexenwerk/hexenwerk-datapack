...
execute unless score @s hexenwerk.has_wand matches 0 if data block ~ ~ ~ Items[{Slot: 12b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] run data remove block ~ ~ ~ Items[{Slot:12b}].tag.display.Lore[0]
...
execute unless score @s hexenwerk.has_wand matches 0 if data block ~ ~ ~ Items[{Slot: 12b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] run function hexenwerk:blocks/magical_crafting_table/wand/reapply_attunement_lore