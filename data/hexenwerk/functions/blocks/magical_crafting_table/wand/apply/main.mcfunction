...
execute if data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-spellbook: 1b}}] run function hexenwerk:blocks/magical_crafting_table/wand/apply/fourth
execute if data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-spellbook: 1b}}] run function hexenwerk:blocks/magical_crafting_table/wand/apply/fifth
...
execute unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-spellbook: 1b}}] run function hexenwerk:blocks/magical_crafting_table/wand/apply/remove/fourth
execute unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-spellbook: 1b}}] run function hexenwerk:blocks/magical_crafting_table/wand/apply/remove/fifth
