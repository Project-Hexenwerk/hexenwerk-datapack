...
item modify block ~ ~ ~ container.12 hexenwerk:attunements/wand/slots
...
item modify block ~ ~ ~ container.12 hexenwerk:attunements/wand/slots/fourth
item modify block ~ ~ ~ container.12 hexenwerk:attunements/wand/slots/fifth