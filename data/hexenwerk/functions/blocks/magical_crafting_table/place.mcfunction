...
summon glow_item_frame ~ ~ ~ {NoGravity: 1b, Silent: 1b, Facing: 1b, Invulnerable: 1b, Invisible: 1b, Fixed: 1b, Tags: ["hexenwerk.block", "hexenwerk.magical_crafting_table"], Item: {id: "minecraft:glow_item_frame", Count: 1b, tag: {CustomModelData: 1726}}}
