...
execute unless entity @s[tag=hexenwerk.refreshing_crafting_result_item] if score @s hexenwerk.crafting_result_time matches 2 unless data block ~ ~ ~ Items[{Slot:15b,tag:{hexenwerk-id:"magical_crafting_table"}}] run function hexenwerk:blocks/magical_crafting_table/magical/craft/remove_output/main