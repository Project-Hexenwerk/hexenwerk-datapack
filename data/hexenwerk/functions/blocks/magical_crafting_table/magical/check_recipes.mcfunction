...
# Ardo
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:blaze_powder"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:blaze_powder"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:blaze_powder"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:fire_charge"}] run scoreboard players set @s hexenwerk.crafting_recipe 1

# Auxiliare
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:glistering_melon_slice"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:scute"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:scute"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:glistering_melon_slice"}] run scoreboard players set @s hexenwerk.crafting_recipe 3
# Wingardium Leviosa
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:shulker_shell"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:shulker_shell"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:shulker_shell"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:ender_pearl"}] run scoreboard players set @s hexenwerk.crafting_recipe 4

# Commovus
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-id:"ender_core"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:ender_pearl"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:ender_pearl"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:repeating_command_block"}] run scoreboard players set @s hexenwerk.crafting_recipe 5

# Aguamenti
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:cod"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:cod"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:cod"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:water_bucket"}] run scoreboard players set @s hexenwerk.crafting_recipe 6

# Ignis Temptates
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:blaze_powder"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-id:"blazing_core"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-id:"blazing_core"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:1001}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:repeating_command_block"}] run scoreboard players set @s hexenwerk.crafting_recipe 7

# Circulum Sanitatem
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:dragon_breath"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:glistering_melon_slice"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:glistering_melon_slice"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:repeating_command_block"}] run scoreboard players set @s hexenwerk.crafting_recipe 8

# Attonus
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:tnt"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:gunpowder"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:gunpowder"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-id: "explosive_core"}}] run scoreboard players set @s hexenwerk.crafting_recipe 9
...
# Iunior
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:ghast_tear"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:poppy"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:poppy"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-id:"spellbook",hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:turtle_egg"}] run scoreboard players set @s hexenwerk.crafting_recipe 12
...
## Attunements
# Expansion/Slots
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"expansion"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"expansion"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"expansion"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-id:"wand",hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"expansion"}}] run scoreboard players set @s hexenwerk.crafting_recipe 16

# Range/Farsight
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"farsight"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"farsight"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"farsight"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-id:"wand",hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"farsight"}}] run scoreboard players set @s hexenwerk.crafting_recipe 17

# Mana Max/Overflow
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-id:"wand",hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] run scoreboard players set @s hexenwerk.crafting_recipe 18

# Mana Cost/Conservation
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-id:"wand",hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] run scoreboard players set @s hexenwerk.crafting_recipe 19

# Mana Cost/Conservation
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-id:"wand",hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] run scoreboard players set @s hexenwerk.crafting_recipe 20
...
execute if score @s hexenwerk.crafting_recipe matches 18 run function hexenwerk:blocks/magical_crafting_table/magical/craft/attunements/mana_max
execute if score @s hexenwerk.crafting_recipe matches 19 run function hexenwerk:blocks/magical_crafting_table/magical/craft/attunements/mana_cost
execute if score @s hexenwerk.crafting_recipe matches 20 run function hexenwerk:blocks/magical_crafting_table/magical/craft/attunements/mana_regen
