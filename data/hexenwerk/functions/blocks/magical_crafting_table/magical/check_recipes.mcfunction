...
# Commovus
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-ender_core:1b}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:ender_pearl"}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:ender_pearl"}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-spellbook:1b,hexenwerk-contained_spell:-1}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:repeating_command_block"}] run scoreboard players set @s hexenwerk.crafting_recipe 5
...
# Ignis Temptates
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:blaze_powder"}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-blaze_core:1b}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-blaze_core:1b}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:leather_horse_armor",tag:{hexenwerk-spellbook:1b,hexenwerk-contained_spell:1001}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:repeating_command_block"}] run scoreboard players set @s hexenwerk.crafting_recipe 7
...
# Mana Max/Overflow
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-wand:1b,hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"overflow"}}] run scoreboard players set @s hexenwerk.crafting_recipe 18

# Mana Cost/Conservation
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-wand:1b,hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"conservation"}}] run scoreboard players set @s hexenwerk.crafting_recipe 19

# Mana Cost/Conservation
execute unless data entity @s item.tag.RecipeItems[5] if data block ~ ~ ~ Items[{Slot:2b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:12b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:10b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] if data block ~ ~ ~ Items[{Slot:11b,id:"minecraft:warped_fungus_on_a_stick",tag:{hexenwerk-wand:1b,hexenwerk-attuned:0b}}] if data block ~ ~ ~ Items[{Slot:20b,id:"minecraft:jigsaw",tag:{hexenwerk-attunement:"refill"}}] run scoreboard players set @s hexenwerk.crafting_recipe 20
