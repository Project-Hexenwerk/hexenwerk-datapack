...
execute if entity @s[tag=hexenwerk.magical_crafting_table.wand] run function hexenwerk:blocks/magical_crafting_table/apply/main
execute if data block ~ ~ ~ Items[{Slot: 0b, tag: {hexenwerk-wand: 1b}}] run function hexenwerk:blocks/magical_crafting_table/shift_in
