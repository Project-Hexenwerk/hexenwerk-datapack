...
execute unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.id set from block ~ ~ ~ Items[{Slot: 5b}].id
...
execute unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.id set from block ~ ~ ~ Items[{Slot: 23b}].id
...
execute unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.tag set from block ~ ~ ~ Items[{Slot: 5b}].tag
...
execute unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.tag set from block ~ ~ ~ Items[{Slot: 23b}].tag
...
execute unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 5b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.Count set from block ~ ~ ~ Items[{Slot: 5b}].Count
...
execute unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-attunements:{spellslot_modifier:1b}}}] unless data block ~ ~ ~ Items[{Slot: 23b, tag: {hexenwerk-gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.Count set from block ~ ~ ~ Items[{Slot: 23b}].Count
