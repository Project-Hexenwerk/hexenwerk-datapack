execute at @p run summon item ~ ~ ~ {Item: {id: "minecraft:barrier", tag: {Changed: 0b, CustomModelData: 1729}, Count: 1b}, Tags: ["extraitem"]}
...
execute unless data block ~ ~ ~ Items[{Slot: 15b, tag: {hexenwerk.gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.id set from block ~ ~ ~ Items[{Slot: 15b}].id
...
execute unless data block ~ ~ ~ Items[{Slot: 15b, tag: {hexenwerk.gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.tag set from block ~ ~ ~ Items[{Slot: 15b}].tag
...
execute unless data block ~ ~ ~ Items[{Slot: 12b, tag: {hexenwerk.gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.Count set from block ~ ~ ~ Items[{Slot: 12b}].Count
...
execute unless data block ~ ~ ~ Items[{Slot: 15b, tag: {hexenwerk.gui: 1b}}] run data modify entity @e[type=item,tag=extraitem,sort=nearest,limit=1] Item.Count set from block ~ ~ ~ Items[{Slot: 15b}].Count
