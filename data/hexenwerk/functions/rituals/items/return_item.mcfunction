...
execute as @a[tag=hexenwerk.this,sort=nearest,limit=1] if score %escape_function hexenwerk.temp matches 0 run function hexenwerk:rituals/items/return_but_both_items_are_the_same
